  ...
  return (
    <>
      <PageHeader
        eyebrow="Financials"
        title="Expenses"
        description="Track spending against jobs for accurate margins"
      ...
      <Section className="space-y-4">
        <div className="grid sm:grid-cols-3 gap-3">
          ...
          <Card>
            <CardContent className="p-4">
              <div className="text-xs text-muted-foreground">Billable to jobs</div>
              <div className="text-2xl font-bold text-emerald-600">${billable.toFixed(2)}</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-4">
              <div className="text-xs text-muted-foreground">Overhead</div>
              <div className="text-2xl font-bold">${(total - billable).toFixed(2)}</div>
            </CardContent>
          </Card>
        </div>
        <Card>
