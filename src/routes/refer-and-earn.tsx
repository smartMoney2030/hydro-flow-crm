  ...
  return (
    <>
      <PageHeader
        eyebrow="Growth"
        title="Refer & Earn"
        description="Reward customers for sending new business"
      />
          ...
          <CardContent className="p-4 flex flex-wrap items-center gap-4">
            ...
            <div className="flex-1 min-w-[240px]">
              ...
              <div className="text-xs text-muted-foreground">
                Customers earn a $100 credit (or check) when a referral completes an install.
                Referred customer gets $50 off.
              </div>
            </div>
