  ...
  return (
    <>
      <PageHeader
        ...
        description="Track every customer's yearly service cycle."
      />
      <Section>
        <KanbanBoard
          ...
          renderCard={(m) => {
            ...
            return (
              <Link to="/customers/$id" params={{ id: c.id }} className="block p-3 space-y-1">
                ...
                <div
                  className={`text-[11px] font-medium ${m.status === "Maintenance Overdue" ? "text-destructive" : "text-primary"}`}
                >
                  {relDays(m.dueDate)}
                </div>
              </Link>
