...
const stock = [
  {
    id: "c1",
    name: "Sodium chloride pellets (40lb)",
    sku: "SLT-40",
    onHand: 68,
    reorder: 40,
    unit: "bag",
  ...
  return (
    <>
      <PageHeader
        ...
        description="Track salt, resin, and treatment inventory"
        actions={<Button size="sm">Log usage</Button>}
      />
                ...
                {stock.map((s) => {
                  ...
                  return (
                    <TableRow key={s.id}>
                      ...
                      <TableCell>
                        {low ? <Badge variant="destructive">Reorder</Badge> : <Badge>OK</Badge>}
                      </TableCell>
                    </TableRow>
                  );
                })}
              ...
              <TableBody>
                {usage.map((u) => (
                  <TableRow key={u.id}>
                    ...
                    <TableCell>{u.tech}</TableCell>
                    <TableCell className="text-muted-foreground">{u.job}</TableCell>
