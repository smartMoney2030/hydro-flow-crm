  ...
  return (
    <>
      <PageHeader
        ...
        description="Rules that run automatically as records change."
      />
          ...
          <CardContent className="p-4 space-y-2">
            {s.automationRuns.map((run) => {
              ...
              return (
                <div
                  key={run.id}
                  className="text-xs flex items-center gap-2 border-b last:border-0 py-2"
                >
