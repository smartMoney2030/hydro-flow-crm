  ...
  return (
    <>
      <PageHeader
        eyebrow="Admin"
        title="Settings"
        description="Session, backups, and production hardening notes."
      />
      <Section className="space-y-4 max-w-3xl">
        <Card>
          ...
          <CardContent className="p-4 space-y-3">
            {[
              ["Require 2FA for administrators", true],
              ["Auto sign-out after 30 min idle", true],
              ["Restrict access by IP", false],
        ...
        <Card className="border-info/40 bg-info/5">
          ...
          <CardContent className="p-4 text-sm space-y-2">
            ...
            <ul className="list-disc pl-5 text-muted-foreground space-y-1 text-xs">
              ...
              <li>
                Postgres row-level security scoped to <code>auth.uid()</code>
              </li>
            ...
            <Button size="sm" className="mt-2 bg-primary">
