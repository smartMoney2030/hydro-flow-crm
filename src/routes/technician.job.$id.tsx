      ...
      <div className="p-4 space-y-3">
        ...
        <Card>
          <CardContent className="p-4 flex items-center gap-2">
            ...
            <label htmlFor="fu" className="text-sm">
              Follow-up required
            </label>
          </CardContent>
        </Card>
        ...
        <Button
          ...
          onClick={() =>
            alert(
              "Job completed (demo). Equipment records created, warranty saved, first maintenance scheduled for +1 year.",
            )
          }
        >
    ...
    <Card>
      <CardContent className="p-4 space-y-2">
        ...
        <div className="relative rounded border-2 border-dashed border-border bg-muted/30">
          ...
          />
          {signed && (
            <div className="absolute top-1 right-2 text-[10px] text-success flex items-center gap-1">
