    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      <div className="hidden lg:flex bg-gradient-hero text-white p-12 flex-col justify-between relative overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 30% 20%, white 0%, transparent 40%), radial-gradient(circle at 80% 70%, white 0%, transparent 40%)",
          }}
        />
        ...
        <div className="relative space-y-4">
          ...
          <p className="text-white/80 max-w-md">
            Sales pipeline, installation scheduling, and annual maintenance in one workspace built
            for water-treatment teams.
          </p>
        </div>
        <div className="relative text-xs text-white/60 flex items-center gap-2">
          <ShieldCheck className="h-4 w-4" />
          Production deployments enforce server-side auth, RLS, and encrypted storage.
        </div>
      </div>
        ...
        <Card className="w-full max-w-md shadow-wave">
          <CardContent className="p-8 space-y-5">
            ...
            <div className="space-y-3">
              <div>
                <Label>Email</Label>
                <Input placeholder="you@mywaterpeople.com" defaultValue="alex@mywaterpeople.com" />
              </div>
              {!forgot && (
                <div>
            ...
            <div className="pt-4 border-t text-xs text-muted-foreground">
              After sign-in, use the role switcher in the top bar to preview the app as Admin,
              Salesperson, Scheduler, or Technician.
              <div className="mt-2">
                <Link to="/technician" className="text-primary hover:underline">
                  Open Technician mobile →
                </Link>
              </div>
            </div>
          </CardContent>
